...
- Ссылки с пометкой `Оригинал` ведут на исходные markdown-файлы в корне репозитория; изображения для полных переводов копируются в локальные `assets` внутри соответствующего русского раздела.
